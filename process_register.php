...
// --- Save to file ---
// MODIFIED LINE: Path is now outside the project folder
...
// --- Redirect on success ---
// Set a success message in the session that the login page can display
$_SESSION['success_message'] = "Registration Success! Please Login";
